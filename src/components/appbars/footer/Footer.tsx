        ...
        <footer className="bg-primary">
            <div className="container">
                ...
                <div className="sm:py-[118px] pt-[104px] max-w-[700px] mx-auto w-full text-center grid place-items-center">
                    {/* TITLE */}
                    <h2 className="title text-white font-normal">Subscribe to get notified about update</h2>
                    <p className="description text-white text-opacity-60 mt-0.5">By subscribing with your mail, you will accept our privacy policy</p>

                    {/* FORM */}
                    <form className="flex flex-col sm:flex-row gap-4 sm:mt-[64px] mt-[50px] w-full">
                        <input type="email" placeholder="Enter your email" className="placeholder:text-opacity-60 text-white leading-[50px] px-[30px] py-[5px] bg-white bg-opacity-[8%] sm:w-[380px] w-full block border border-transparent rounded-lg focus:outline-none focus:border-secondary" />
                        <Button variant="secondary" className="leading-[50px] text-lg py-[5px] !font-medium rounded-lg w-fit mx-auto sm:mx-0">Subscribe us</Button>
                    </form>
                </div>
