        ...
        <section id="clients" className="sm:pt-[100px] sm:pb-[200px] py-[50px]">
            <div className="container">
                ...
                <div className="text-center sm:mb-[50px] mb-[25px] max-w-2xl mx-auto">
                    <h2 className="title sm:mb-2.5 mb-5">Trusted more than <span>100+</span> in the world</h2>
                    <p className="description sm:px-16">they have asked us more than 3 times to teach their employees about various things. to improve their skills</p>
                </div>
                {/* TITLE */}
