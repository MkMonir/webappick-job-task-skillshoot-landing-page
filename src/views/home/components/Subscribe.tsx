                ...
                <div className="bg-[#F2E7DB] rounded-lg px-[60px] py-[60px] relative">
                    ...
                    <div className="flex gap-20">
                        ...
                        <div className="absolute bottom-0 right-28">
                            {/* RIGHT SIDE IMAGE */}
                            <Image src="/assets/images/banner-img.png" alt="Banner Image" width={300} height={430} className="hidden lg:block" />

                            {/* SHAPES */}
                            <Image src="/assets/images/banner-svg-one.svg" alt="Banner Shapes" className="absolute top-[50%] -left-12 hidden sm:block" width={60} height={60} />
                            <Image src="/assets/images/banner-svg-two.svg" alt="Banner Shapes" className="absolute top-[50%] -right-12 hidden sm:block" width={50} height={50} />
