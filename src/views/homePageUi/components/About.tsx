        ...
        <section id="about" className="">
            <div className="container sm:py-[100px] py-[50px]">
                <div className="grid lg:grid-cols-2 items-center">
                    ...
                    <div>
                        <h2 className="title sm:text-5xl sm:leading-[72px] font-bold sm:mb-9 mb-5">Let us <span className="!text-primary relative after:content-[' '] after:bg-[url('/assets/images/title-bottom-shape.svg')] after:bg-no-repeat after:w-full after:h-5 after:absolute after:-bottom-4 after:left-0">Skill Shoot</span></h2>
                        ...
                        <ul className="grid grid-cols-2 md:gap-x-[100px] md:gap-y-[30px] gap-x-8 gap-y-5 mt-9">
                            {aboutFeatures?.map((feature, i) => (
                                <li key={i} className="flex items-center gap-4">
                                    ...
                                    <p className="font-semibold text-xs sm:text-base sm:leading-[35px] leading-[30px] text-[#2C2C2C]">{feature.text}</p>
                                </li>
                            ))}
                        </ul>
                    </div>
